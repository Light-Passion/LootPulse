...
namespace LootPulse.Models
{
    ...
    {
        public const string DefaultBorderColor = "#FFFF6124";
        public const string DefaultBackgroundColor = "#00000000";

        public bool Enabled { get; set; } = true;
        public string TextColor { get; set; } = "#FFFFFFFF";       // HEX string (AARRGGBB)
        public string BorderColor { get; set; } = DefaultBorderColor;     // HEX string (AARRGGBB)
        public string BackgroundColor { get; set; } = DefaultBackgroundColor; // HEX string (AARRGGBB)
        ...
        public bool MuteDefaultDropSound { get; set; }  // Maps to DisableDropSound
    ...
    public class FilterTheme
    {
        ...
        {
            TextColor = "#FFFF6124",
            BorderColor = CategoryStyle.DefaultBorderColor,
            BackgroundColor = CategoryStyle.DefaultBackgroundColor,
            FontSize = 45,
            SoundType = "BuiltIn",
            AlertSoundId = 1,
